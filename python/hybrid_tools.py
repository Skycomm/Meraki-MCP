...
async def get_network_webhook_http_servers(network_id: str) -> str:
...
async def create_network_webhook_http_server(network_id: str, name: str, url: str, shared_secret: str = None) -> str:
...
async def get_network_alerts_settings(network_id: str) -> str:
    """⚠️ Get alert settings for a network"""
    if not meraki_client:
        return "Error: Meraki client not initialized"
...
async def update_network_alerts_settings(network_id: str, emails: str = None, all_admins: bool = None, 
                                     ...
                                     enable_ip_conflict: bool = None) -> str:
    """⚠️ Update alert settings for a network"""
    if not meraki_client:
        return "Error: Meraki client not initialized"
...
async def get_organization_uplinks_loss_and_latency(org_id: str, timespan: int = 300) -> str:
    """"""
    if not meraki_client:
        return "Error: Meraki client not initialized"
...
async def get_organization_appliance_uplink_statuses(org_id: str) -> str:
...
async def get_network_connection_stats(network_id: str, timespan: int = 86400) -> str:
...
async def get_network_latency_stats(network_id: str, timespan: int = 86400) -> str:
...
async def get_network_appliance_firewall_l3_rules(network_id: str) -> str:
...
async def update_network_appliance_firewall_l3_rules(network_id: str, 
        comment: str,
        policy: str,
        protocol: str = "any",
        src_cidr: str = "any",
...
async def get_network_appliance_content_filtering(network_id: str) -> str:
...
async def get_network_appliance_vpn_site_to_site(network_id: str) -> str:
...
async def get_network_appliance_security_malware(network_id: str) -> str:
    """🛡️ Get malware protection settings for a network"""
    if not meraki_client:
        return "Error: Meraki client not initialized"
...
async def get_network_appliance_security_intrusion(network_id: str) -> str:
    """🚨 Get intrusion detection/prevention settings"""
    if not meraki_client:
        return "Error: Meraki client not initialized"
...
async def get_organization_early_access_features(org_id: str) -> str:
    """🧪 List available early access features for organization"""
    if not meraki_client:
        return "Error: Meraki client not initialized"
...
async def get_organization_early_access_opt_ins(org_id: str) -> str:
    """🧪 List early access features opted into by organization"""
    if not meraki_client:
        return "Error: Meraki client not initialized"
...
async def enable_organization_early_access_feature(org_id: str, feature_id: str, limit_to_networks: str = None) -> str:
    """🧪 Enable an early access feature for organization"""
    if not meraki_client:
        return "Error: Meraki client not initialized"
...
async def disable_organization_early_access_feature(org_id: str, opt_in_id: str) -> str:
    """🧪 Disable an early access feature for organization"""
    if not meraki_client:
        return "Error: Meraki client not initialized"
...
async def get_organization_api_analytics(org_id: str, timespan: int = 86400) -> str:
    """📊 View API usage analytics dashboard data"""
    if not meraki_client:
        return "Error: Meraki client not initialized"
...
async def check_beta_apis_status() -> str:
    """🧪 Check which beta APIs might be available"""
    if not meraki_client:
        return "Error: Meraki client not initialized"
...
async def get_device_camera_video_link(serial: str, timestamp: str = None) -> str:
...
async def get_device_camera_snapshot(serial: str, timestamp: str = None) -> str:
...
async def get_device_camera_video_settings(serial: str) -> str:
    """⚙️ Get video settings for a camera"""
    if not meraki_client:
        return "Error: Meraki client not initialized"
...
async def update_device_camera_video_settings(serial: str, external_rtsp_enabled: bool) -> str:
    """⚙️ Update video settings for a camera"""
    if not meraki_client:
        return "Error: Meraki client not initialized"
...
async def get_device_camera_analytics_zones(serial: str) -> str:
...
async def get_device_camera_sense(serial: str) -> str:
...
async def get_device(serial: str) -> str:
...
async def update_device(serial: str, name: str = None, tags: list = None, address: str = None) -> str:
...
async def reboot_device(serial: str) -> str:
    """⚠️ REBOOT a Meraki device - REQUIRES CONFIRMATION"""
    if not meraki_client:
        return "Error: Meraki client not initialized"
...
async def confirm_reboot_device(serial: str, confirmation: str) -> str:
    """"""
    if not meraki_client:
        return "Error: Meraki client not initialized"
...
async def get_device_clients(serial: str) -> str:
...
async def get_organization_licenses(org_id: str) -> str:
    """📄 List all licenses in an organization"""
    if not meraki_client:
        return "Error: Meraki client not initialized"
...
async def get_organization_licensing_coterm(org_id: str) -> str:
    """📊 Get co-termination licensing info for organization"""
    if not meraki_client:
        return "Error: Meraki client not initialized"
...
async def claim_organization_license(org_id: str, license_key: str) -> str:
    """🔑 Claim a license key for an organization"""
    if not meraki_client:
        return "Error: Meraki client not initialized"
...
async def update_organization_license(org_id: str, license_id: str, device_serial: str = None) -> str:
    """"""
    if not meraki_client:
        return "Error: Meraki client not initialized"
...
async def move_organization_licenses(source_org_id: str, dest_org_id: str, license_ids: str) -> str:
...
async def renew_organization_licenses_seats(org_id: str, license_id_to_renew: str, unused_license_id: str) -> str:
    """🔄 Renew SM seats for an organization"""
    if not meraki_client:
        return "Error: Meraki client not initialized"
...
async def create_device_ping_test(serial: str, target: str, count: int = 5) -> str:
    """"""
    if not meraki_client:
        return "Error: Meraki client not initialized"
...
async def get_device_ping_test(serial: str, ping_id: str) -> str:
    """"""
    if not meraki_client:
        return "Error: Meraki client not initialized"
...
async def create_device_throughput_test(serial: str, target_serial: str) -> str:
    """"""
    if not meraki_client:
        return "Error: Meraki client not initialized"
...
async def get_device_throughput_test(serial: str, test_id: str) -> str:
    """"""
    if not meraki_client:
        return "Error: Meraki client not initialized"
...
async def create_switch_cable_test(serial: str, port: str) -> str:
    """"""
    if not meraki_client:
        return "Error: Meraki client not initialized"
...
async def get_switch_cable_test(serial: str, test_id: str) -> str:
    """"""
    if not meraki_client:
        return "Error: Meraki client not initialized"
...
async def create_device_wake_on_lan(serial: str, vlan_id: int, mac_address: str) -> str:
    """"""
    if not meraki_client:
        return "Error: Meraki client not initialized"
...
async def create_switch_mac_table(serial: str) -> str:
    """"""
    if not meraki_client:
        return "Error: Meraki client not initialized"
...
async def get_switch_mac_table(serial: str, request_id: str) -> str:
    """"""
    if not meraki_client:
        return "Error: Meraki client not initialized"
...
async def blink_device_leds(serial: str, duration: int = 30) -> str:
    """"""
    if not meraki_client:
        return "Error: Meraki client not initialized"
...
async def get_device_memory_history(serial: str, timespan: int = 3600) -> str:
    """"""
    if not meraki_client:
        return "Error: Meraki client not initialized"
...
async def get_device_cpu_power_mode_history(serial: str, timespan: int = 3600) -> str:
    """"""
    if not meraki_client:
        return "Error: Meraki client not initialized"
...
async def get_device_wireless_cpu_load(serial: str) -> str:
    """"""
    if not meraki_client:
        return "Error: Meraki client not initialized"
...
async def get_organization_switch_ports_history(org_id: str, timespan: int = 3600) -> str:
    """"""
    if not meraki_client:
        return "Error: Meraki client not initialized"
...
async def get_organization_devices_migration_status(org_id: str) -> str:
    """"""
    if not meraki_client:
        return "Error: Meraki client not initialized"
...
async def get_organization_api_usage(org_id: str, timespan: int = 86400) -> str:
    """📈 Get API usage analytics for the organization"""
    if not meraki_client:
        return "Error: Meraki client not initialized"
...
async def get_network(network_id: str) -> str:
...
async def update_network(network_id: str, name: str = None, tags: list = None) -> str:
...
async def get_network_clients(network_id: str) -> str:
...
async def create_network(organization_id: str, name: str, product_types: str = "wireless") -> str:
...
async def get_organization_alerts(org_id: str) -> str:
...
async def update_organization(organization_id: str, name: str = None) -> str:
...
async def delete_organization(organization_id: str) -> str:
...
async def get_organization_firmware(org_id: str) -> str:
...
async def get_organization_policy_objects(org_id: str) -> str:
    """🛡️ List all policy objects in an organization"""
    if not meraki_client:
        return "Error: Meraki client not initialized"
...
async def create_organization_policy_object(org_id: str, name: str, category: str, type: str, cidr: str = None, fqdn: str = None, ip: str = None) -> str:
    """🛡️ Create a new policy object"""
    if not meraki_client:
        return "Error: Meraki client not initialized"
...
async def update_organization_policy_object(org_id: str, policy_object_id: str, name: str = None, cidr: str = None, fqdn: str = None) -> str:
...
async def delete_organization_policy_object(org_id: str, policy_object_id: str) -> str:
    """🗑️ Delete a policy object"""
    if not meraki_client:
        return "Error: Meraki client not initialized"
...
async def get_organization_policy_objects_groups(org_id: str) -> str:
    """📁 List all policy object groups"""
    if not meraki_client:
        return "Error: Meraki client not initialized"
...
async def create_organization_policy_objects_group(org_id: str, name: str, category: str, object_ids: str = None) -> str:
...
async def get_network_sm_devices(network_id: str) -> str:
    """"""
    if not meraki_client:
        return "Error: Meraki client not initialized"
...
async def get_network_sm_device_detail(network_id: str, device_id: str) -> str:
    """📱 Get detailed info for a specific SM device"""
    if not meraki_client:
        return "Error: Meraki client not initialized"
...
async def get_network_sm_device_apps(network_id: str, device_id: str) -> str:
    """📲 List installed apps on an SM device"""
    if not meraki_client:
        return "Error: Meraki client not initialized"
...
async def reboot_network_sm_devices(network_id: str, device_ids: str) -> str:
    """⚠️ REBOOT Systems Manager devices - REQUIRES CONFIRMATION"""
    if not meraki_client:
        return "Error: Meraki client not initialized"
...
async def confirm_reboot_network_sm_devices(network_id: str, device_ids: str, confirmation: str) -> str:
    """"""
    if not meraki_client:
        return "Error: Meraki client not initialized"
...
async def get_network_sm_profiles(network_id: str) -> str:
    """📋 List Systems Manager profiles"""
    if not meraki_client:
        return "Error: Meraki client not initialized"
...
async def get_network_sm_performance_history(network_id: str, device_id: str) -> str:
...
async def get_device_switch_ports(serial: str) -> str:
...
async def update_device_switch_port(serial: str, port_number: int, name: str = None, enabled: bool = None, 
                                 vlan: int = None, poe_enabled: bool = None) -> str:
...
async def get_device_switch_port_statuses(serial: str) -> str:
...
async def get_device_switch_vlans(serial: str) -> str:
...
async def create_device_switch_vlan(serial: str, vlan_id: int, name: str, subnet: str = None) -> str:
...
async def get_network_wireless_ssids(network_id: str) -> str:
...
async def get_network_wireless_passwords(network_id: str) -> str:
...
async def update_network_wireless_ssid(network_id: str, ssid_number: int, name: str = None, enabled: bool = None) -> str:
...
async def get_network_wireless_clients(network_id: str) -> str:
...
async def get_network_wireless_usage(network_id: str, ssid_number: int = None, device_serial: str = None) -> str:
...
async def get_network_wireless_rf_profiles(network_id: str) -> str:
...
async def get_network_wireless_air_marshal(network_id: str, timespan: int = 3600) -> str:
    """🛡️ Get Air Marshal security scan results"""
    if not meraki_client:
        return "Error: Meraki client not initialized"
...
async def get_network_wireless_bluetooth_clients(network_id: str) -> str:
    """📱 Get Bluetooth clients in a wireless network"""
    if not meraki_client:
        return "Error: Meraki client not initialized"
...
async def get_network_wireless_channel_utilization(network_id: str, timespan: int = 3600, ssid_number: int = None, device_serial: str = None) -> str:
...
MERAKI_TOOLS = {
    "get_organization_webhooks": lambda: get_organization_webhooks(**request.arguments),
    "create_organization_webhook": lambda: create_organization_webhook(**request.arguments),
    "get_network_webhook_http_servers": lambda: get_network_webhook_http_servers(**request.arguments),
    "create_network_webhook_http_server": lambda: create_network_webhook_http_server(**request.arguments),
    "get_network_alerts_settings": lambda: get_network_alerts_settings(**request.arguments),
    "update_network_alerts_settings": lambda: update_network_alerts_settings(**request.arguments),
    "get_organization_uplinks_loss_and_latency": lambda: get_organization_uplinks_loss_and_latency(**request.arguments),
    "get_organization_appliance_uplink_statuses": lambda: get_organization_appliance_uplink_statuses(**request.arguments),
    "get_network_connection_stats": lambda: get_network_connection_stats(**request.arguments),
    "get_network_latency_stats": lambda: get_network_latency_stats(**request.arguments),
    "get_network_appliance_firewall_l3_rules": lambda: get_network_appliance_firewall_l3_rules(**request.arguments),
    "update_network_appliance_firewall_l3_rules": lambda: update_network_appliance_firewall_l3_rules(**request.arguments),
    "get_network_appliance_content_filtering": lambda: get_network_appliance_content_filtering(**request.arguments),
    "get_network_appliance_vpn_site_to_site": lambda: get_network_appliance_vpn_site_to_site(**request.arguments),
    "get_network_appliance_security_malware": lambda: get_network_appliance_security_malware(**request.arguments),
    "get_network_appliance_security_intrusion": lambda: get_network_appliance_security_intrusion(**request.arguments),
    "get_organization_early_access_features": lambda: get_organization_early_access_features(**request.arguments),
    "get_organization_early_access_opt_ins": lambda: get_organization_early_access_opt_ins(**request.arguments),
    "enable_organization_early_access_feature": lambda: enable_organization_early_access_feature(**request.arguments),
    "disable_organization_early_access_feature": lambda: disable_organization_early_access_feature(**request.arguments),
    "get_organization_api_analytics": lambda: get_organization_api_analytics(**request.arguments),
    "check_beta_apis_status": check_beta_apis_status,
    "get_device_camera_video_link": lambda: get_device_camera_video_link(**request.arguments),
    "get_device_camera_snapshot": lambda: get_device_camera_snapshot(**request.arguments),
    "get_device_camera_video_settings": lambda: get_device_camera_video_settings(**request.arguments),
    "update_device_camera_video_settings": lambda: update_device_camera_video_settings(**request.arguments),
    "get_device_camera_analytics_zones": lambda: get_device_camera_analytics_zones(**request.arguments),
    "get_device_camera_sense": lambda: get_device_camera_sense(**request.arguments),
    "get_device": lambda: get_device(**request.arguments),
    "update_device": lambda: update_device(**request.arguments),
    "reboot_device": lambda: reboot_device(**request.arguments),
    "confirm_reboot_device": lambda: confirm_reboot_device(**request.arguments),
    "get_device_clients": lambda: get_device_clients(**request.arguments),
    "get_device_status": lambda: get_device_status(**request.arguments),
    "get_organization_licenses": lambda: get_organization_licenses(**request.arguments),
    "get_organization_licensing_coterm": lambda: get_organization_licensing_coterm(**request.arguments),
    "claim_organization_license": lambda: claim_organization_license(**request.arguments),
    "update_organization_license": lambda: update_organization_license(**request.arguments),
    "move_organization_licenses": lambda: move_organization_licenses(**request.arguments),
    "renew_organization_licenses_seats": lambda: renew_organization_licenses_seats(**request.arguments),
    "create_device_ping_test": lambda: create_device_ping_test(**request.arguments),
    "get_device_ping_test": lambda: get_device_ping_test(**request.arguments),
    "create_device_throughput_test": lambda: create_device_throughput_test(**request.arguments),
    "get_device_throughput_test": lambda: get_device_throughput_test(**request.arguments),
    "create_switch_cable_test": lambda: create_switch_cable_test(**request.arguments),
    "get_switch_cable_test": lambda: get_switch_cable_test(**request.arguments),
    "create_device_wake_on_lan": lambda: create_device_wake_on_lan(**request.arguments),
    "create_switch_mac_table": lambda: create_switch_mac_table(**request.arguments),
    "get_switch_mac_table": lambda: get_switch_mac_table(**request.arguments),
    "blink_device_leds": lambda: blink_device_leds(**request.arguments),
    "get_device_memory_history": lambda: get_device_memory_history(**request.arguments),
    "get_device_cpu_power_mode_history": lambda: get_device_cpu_power_mode_history(**request.arguments),
    "get_device_wireless_cpu_load": lambda: get_device_wireless_cpu_load(**request.arguments),
    "get_organization_switch_ports_history": lambda: get_organization_switch_ports_history(**request.arguments),
    "get_organization_devices_migration_status": lambda: get_organization_devices_migration_status(**request.arguments),
    "get_organization_api_usage": lambda: get_organization_api_usage(**request.arguments),
    "get_network": lambda: get_network(**request.arguments),
    "update_network": lambda: update_network(**request.arguments),
    "get_network_devices": lambda: get_network_devices(**request.arguments),
    "get_network_clients": lambda: get_network_clients(**request.arguments),
    "create_network": lambda: create_network(**request.arguments),
    "delete_network": lambda: delete_network(**request.arguments),
    "list_organizations": list_organizations,
    "get_organization": lambda: get_organization(**request.arguments),
    "get_organization_networks": lambda: get_organization_networks(**request.arguments),
    "get_organization_alerts": lambda: get_organization_alerts(**request.arguments),
    "create_organization": lambda: create_organization(**request.arguments),
    "update_organization": lambda: update_organization(**request.arguments),
    "delete_organization": lambda: delete_organization(**request.arguments),
    "get_organization_firmware": lambda: get_organization_firmware(**request.arguments),
    "get_organization_policy_objects": lambda: get_organization_policy_objects(**request.arguments),
    "create_organization_policy_object": lambda: create_organization_policy_object(**request.arguments),
    "update_organization_policy_object": lambda: update_organization_policy_object(**request.arguments),
    "delete_organization_policy_object": lambda: delete_organization_policy_object(**request.arguments),
    "get_organization_policy_objects_groups": lambda: get_organization_policy_objects_groups(**request.arguments),
    "create_organization_policy_objects_group": lambda: create_organization_policy_objects_group(**request.arguments),
    "get_network_sm_devices": lambda: get_network_sm_devices(**request.arguments),
    "get_network_sm_device_detail": lambda: get_network_sm_device_detail(**request.arguments),
    "get_network_sm_device_apps": lambda: get_network_sm_device_apps(**request.arguments),
    "reboot_network_sm_devices": lambda: reboot_network_sm_devices(**request.arguments),
    "confirm_reboot_network_sm_devices": lambda: confirm_reboot_network_sm_devices(**request.arguments),
    "get_network_sm_profiles": lambda: get_network_sm_profiles(**request.arguments),
    "get_network_sm_performance_history": lambda: get_network_sm_performance_history(**request.arguments),
    "get_device_switch_ports": lambda: get_device_switch_ports(**request.arguments),
    "update_device_switch_port": lambda: update_device_switch_port(**request.arguments),
    "get_device_switch_port_statuses": lambda: get_device_switch_port_statuses(**request.arguments),
    "get_device_switch_vlans": lambda: get_device_switch_vlans(**request.arguments),
    "create_device_switch_vlan": lambda: create_device_switch_vlan(**request.arguments),
    "get_network_wireless_ssids": lambda: get_network_wireless_ssids(**request.arguments),
    "get_network_wireless_passwords": lambda: get_network_wireless_passwords(**request.arguments),
    "update_network_wireless_ssid": lambda: update_network_wireless_ssid(**request.arguments),
    "get_network_wireless_clients": lambda: get_network_wireless_clients(**request.arguments),
    "get_network_wireless_usage": lambda: get_network_wireless_usage(**request.arguments),
    "get_network_wireless_rf_profiles": lambda: get_network_wireless_rf_profiles(**request.arguments),
    "get_network_wireless_air_marshal": lambda: get_network_wireless_air_marshal(**request.arguments),
    "get_network_wireless_bluetooth_clients": lambda: get_network_wireless_bluetooth_clients(**request.arguments),
    "get_network_wireless_channel_utilization": lambda: get_network_wireless_channel_utilization(**request.arguments),
}