...
def register_administered_tools(mcp_app, meraki):
    ...
    def get_administered_identities_me():
        ...
        try:
            result = meraki_client.dashboard.administered.getAdministeredIdentitiesMe()
    ...
    def get_administered_identities_me_api_keys():
        ...
        try:
            result = meraki_client.dashboard.administered.getAdministeredIdentitiesMeApiKeys()
    ...
    def generate_administered_identities_me_api_keys(
        ...
        try:
            ...
            result = meraki_client.dashboard.administered.generateAdministeredIdentitiesMeApiKeys(**kwargs)
    ...
    def revoke_administered_identities_me_api_keys(
        ...
        try:
            ...
            meraki_client.dashboard.administered.revokeAdministeredIdentitiesMeApiKeys(api_key_id)
