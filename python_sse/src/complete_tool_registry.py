"""
Complete Auto-generated Tool Registry from stdio server.
Contains all Meraki MCP tools with implementations.
Generated from working tool_registry.py - guaranteed to work!
"""
...
TOOL_METADATA = {
    ...
    "get_organization": {
        ...
        "parameters": [{"name": "organization_id", "type": "str", "default": None, "required": True}]
    },
    "get_organization_networks": {
        "description": "List networks in a Meraki organization.\n        \n        Args:\n            org_id: ID of the organization\n            \n        Returns:\n            Formatted list of networks",
        "parameters": [{"name": "org_id", "type": "str", "default": None, "required": True}]
    },
    ...
    "create_organization": {
        ...
        "parameters": [{"name": "name", "type": "str", "default": None, "required": True}]
    },
    "update_organization": {
        "description": "Update a Meraki organization.\n        \n        Args:\n            organization_id: ID of the organization to update\n            name: New name for the organization (optional)\n            \n        Returns:\n            Updated organization details",
        "parameters": [{"name": "organization_id", "type": "str", "default": None, "required": True}, {"name": "name", "type": "str", "default": "None", "required": False}]
    },
    "delete_organization": {
    ...
    "update_network": {
        ...
        "parameters": [{"name": "network_id", "type": "str", "default": None, "required": True}, {"name": "name", "type": "str", "default": "None", "required": False}, {"name": "tags", "type": "list", "default": "None", "required": False}]
    },
    "get_network_devices": {
    ...
    "create_network": {
        ...
        "parameters": [{"name": "organization_id", "type": "str", "default": None, "required": True}, {"name": "name", "type": "str", "default": None, "required": True}, {"name": "product_types", "type": "str", "default": "\"wireless\"", "required": False}]
    },
    "delete_network": {
    ...
    "update_device": {
        ...
        "parameters": [{"name": "serial", "type": "str", "default": None, "required": True}, {"name": "name", "type": "str", "default": "None", "required": False}, {"name": "tags", "type": "list", "default": "None", "required": False}, {"name": "address", "type": "str", "default": "None", "required": False}]
    },
    "reboot_device": {
    ...
    "confirm_reboot_device": {
        ...
        "parameters": [{"name": "serial", "type": "str", "default": None, "required": True}, {"name": "confirmation", "type": "str", "default": None, "required": True}]
    },
    "get_device_clients": {
    ...
    "update_network_wireless_ssid": {
        ...
        "parameters": [{"name": "network_id", "type": "str", "default": None, "required": True}, {"name": "ssid_number", "type": "int", "default": None, "required": True}, {"name": "name", "type": "str", "default": "None", "required": False}, {"name": "enabled", "type": "bool", "default": "None", "required": False}]
    },
    ...
    "get_network_wireless_usage": {
        ...
        "parameters": [{"name": "network_id", "type": "str", "default": None, "required": True}, {"name": "ssid_number", "type": "int", "default": "None", "required": False}, {"name": "device_serial", "type": "str", "default": "None", "required": False}]
    },
    ...
    "get_network_wireless_air_marshal": {
        ...
        "parameters": [{"name": "network_id", "type": "str", "default": None, "required": True}, {"name": "timespan", "type": "int", "default": "3600", "required": False}]
    },
    ...
    "get_network_wireless_channel_utilization": {
        ...
        "parameters": [{"name": "network_id", "type": "str", "default": None, "required": True}, {"name": "timespan", "type": "int", "default": "3600", "required": False}, {"name": "ssid_number", "type": "int", "default": "None", "required": False}, {"name": "device_serial", "type": "str", "default": "None", "required": False}]
    },
    ...
    "create_device_switch_vlan": {
        ...
        "parameters": [{"name": "serial", "type": "str", "default": None, "required": True}, {"name": "vlan_id", "type": "int", "default": None, "required": True}, {"name": "name", "type": "str", "default": None, "required": True}, {"name": "subnet", "type": "str", "default": "None", "required": False}]
    },
    "get_organization_uplinks_loss_and_latency": {
        ...
        "parameters": [{"name": "org_id", "type": "str", "default": None, "required": True}, {"name": "timespan", "type": "int", "default": "300", "required": False}]
    },
    ...
    "get_network_connection_stats": {
        ...
        "parameters": [{"name": "network_id", "type": "str", "default": None, "required": True}, {"name": "timespan", "type": "int", "default": "86400", "required": False}]
    },
    ...
    "create_organization_webhook": {
        ...
        "parameters": [{"name": "org_id", "type": "str", "default": None, "required": True}, {"name": "name", "type": "str", "default": None, "required": True}, {"name": "url", "type": "str", "default": None, "required": True}, {"name": "shared_secret", "type": "str", "default": "None", "required": False}]
    },
    ...
    "create_network_webhook_http_server": {
        ...
        "parameters": [{"name": "network_id", "type": "str", "default": None, "required": True}, {"name": "name", "type": "str", "default": None, "required": True}, {"name": "url", "type": "str", "default": None, "required": True}, {"name": "shared_secret", "type": "str", "default": "None", "required": False}]
    },
    ...
    "get_device_camera_video_link": {
        ...
        "parameters": [{"name": "serial", "type": "str", "default": None, "required": True}, {"name": "timestamp", "type": "str", "default": "None", "required": False}]
    },
    ...
    "update_device_camera_video_settings": {
        ...
        "parameters": [{"name": "serial", "type": "str", "default": None, "required": True}, {"name": "external_rtsp_enabled", "type": "bool", "default": None, "required": True}]
    },
    ...
    "get_network_sm_device_detail": {
        ...
        "parameters": [{"name": "network_id", "type": "str", "default": None, "required": True}, {"name": "device_id", "type": "str", "default": None, "required": True}]
    },
    ...
    "reboot_network_sm_devices": {
        ...
        "parameters": [{"name": "network_id", "type": "str", "default": None, "required": True}, {"name": "device_ids", "type": "str", "default": None, "required": True}]
    },
    "confirm_reboot_network_sm_devices": {
        "description": "Actually reboot SM devices after explicit confirmation.\n        \n        Args:\n            network_id: Network ID\n            device_ids: Comma-separated device IDs to reboot\n            confirmation: Must be exactly \"YES-REBOOT-SM-[network_id]\" to proceed\n            \n        Returns:\n            Reboot command status",
        "parameters": [{"name": "network_id", "type": "str", "default": None, "required": True}, {"name": "device_ids", "type": "str", "default": None, "required": True}, {"name": "confirmation", "type": "str", "default": None, "required": True}]
    },
    ...
    "claim_organization_license": {
        ...
        "parameters": [{"name": "org_id", "type": "str", "default": None, "required": True}, {"name": "license_key", "type": "str", "default": None, "required": True}]
    },
    "update_organization_license": {
        "description": "Update a license (typically to assign/unassign to a device).\n        \n        Args:\n            org_id: Organization ID\n            license_id: License ID to update\n            device_serial: Device serial to assign to (or empty to unassign)\n            \n        Returns:\n            Update result",
        "parameters": [{"name": "org_id", "type": "str", "default": None, "required": True}, {"name": "license_id", "type": "str", "default": None, "required": True}, {"name": "device_serial", "type": "str", "default": "None", "required": False}]
    },
    "move_organization_licenses": {
        "description": "Move licenses from one organization to another.\n        \n        Args:\n            source_org_id: Source organization ID\n            dest_org_id: Destination organization ID\n            license_ids: Comma-separated license IDs to move\n            \n        Returns:\n            Move result",
        "parameters": [{"name": "source_org_id", "type": "str", "default": None, "required": True}, {"name": "dest_org_id", "type": "str", "default": None, "required": True}, {"name": "license_ids", "type": "str", "default": None, "required": True}]
    },
    "renew_organization_licenses_seats": {
        "description": "Renew Systems Manager seats by combining licenses.\n        \n        Args:\n            org_id: Organization ID\n            license_id_to_renew: License ID that needs renewal\n            unused_license_id: Unused license ID to apply for renewal\n            \n        Returns:\n            Renewal result",
        "parameters": [{"name": "org_id", "type": "str", "default": None, "required": True}, {"name": "license_id_to_renew", "type": "str", "default": None, "required": True}, {"name": "unused_license_id", "type": "str", "default": None, "required": True}]
    },
    ...
    "create_organization_policy_object": {
        ...
        "parameters": [{"name": "org_id", "type": "str", "default": None, "required": True}, {"name": "name", "type": "str", "default": None, "required": True}, {"name": "category", "type": "str", "default": None, "required": True}, {"name": "type", "type": "str", "default": None, "required": True}, {"name": "cidr", "type": "str", "default": "None", "required": False}, {"name": "fqdn", "type": "str", "default": "None", "required": False}, {"name": "ip", "type": "str", "default": "None", "required": False}]
    },
    "update_organization_policy_object": {
        "description": "Update an existing policy object.\n        \n        Args:\n            org_id: Organization ID\n            policy_object_id: Policy object ID\n            name: New name (optional)\n            cidr: New CIDR for IP objects (optional)\n            fqdn: New FQDN for domain objects (optional)\n            \n        Returns:\n            Updated policy object",
        "parameters": [{"name": "org_id", "type": "str", "default": None, "required": True}, {"name": "policy_object_id", "type": "str", "default": None, "required": True}, {"name": "name", "type": "str", "default": "None", "required": False}, {"name": "cidr", "type": "str", "default": "None", "required": False}, {"name": "fqdn", "type": "str", "default": "None", "required": False}]
    },
    "delete_organization_policy_object": {
        "description": "Delete a policy object.\n        \n        Args:\n            org_id: Organization ID\n            policy_object_id: Policy object ID to delete\n            \n        Returns:\n            Deletion confirmation",
        "parameters": [{"name": "org_id", "type": "str", "default": None, "required": True}, {"name": "policy_object_id", "type": "str", "default": None, "required": True}]
    },
    ...
    "create_organization_policy_objects_group": {
        ...
        "parameters": [{"name": "org_id", "type": "str", "default": None, "required": True}, {"name": "name", "type": "str", "default": None, "required": True}, {"name": "category", "type": "str", "default": None, "required": True}, {"name": "object_ids", "type": "str", "default": "None", "required": False}]
    },
    "get_device_memory_history": {
        "description": "Get memory utilization history for a device.\n        \n        Args:\n            serial: Device serial number\n            timespan: Time span in seconds (default 1 hour)\n            \n        Returns:\n            Memory utilization history",
        "parameters": [{"name": "serial", "type": "str", "default": None, "required": True}, {"name": "timespan", "type": "int", "default": "3600", "required": False}]
    },
    ...
    "get_organization_switch_ports_history": {
        ...
        "parameters": [{"name": "org_id", "type": "str", "default": None, "required": True}, {"name": "timespan", "type": "int", "default": "3600", "required": False}]
    },
    ...
    "get_organization_api_usage": {
        ...
        "parameters": [{"name": "org_id", "type": "str", "default": None, "required": True}, {"name": "timespan", "type": "int", "default": "86400", "required": False}]
    },
    ...
    "enable_organization_early_access_feature": {
        ...
        "parameters": [{"name": "org_id", "type": "str", "default": None, "required": True}, {"name": "feature_id", "type": "str", "default": None, "required": True}, {"name": "limit_to_networks", "type": "str", "default": "None", "required": False}]
    },
    "disable_organization_early_access_feature": {
        "description": "Opt out of an early access feature for the organization.\n        \n        Args:\n            org_id: Organization ID\n            opt_in_id: Opt-in ID to disable\n            \n        Returns:\n            Opt-out confirmation",
        "parameters": [{"name": "org_id", "type": "str", "default": None, "required": True}, {"name": "opt_in_id", "type": "str", "default": None, "required": True}]
    },
    ...
    "create_device_ping_test": {
        ...
        "parameters": [{"name": "serial", "type": "str", "default": None, "required": True}, {"name": "target", "type": "str", "default": None, "required": True}, {"name": "count", "type": "int", "default": "5", "required": False}]
    },
    "get_device_ping_test": {
        "description": "Get results of a ping test.\n        \n        Args:\n            serial: Device serial number\n            ping_id: Ping test job ID\n            \n        Returns:\n            Ping test results",
        "parameters": [{"name": "serial", "type": "str", "default": None, "required": True}, {"name": "ping_id", "type": "str", "default": None, "required": True}]
    },
    "create_device_throughput_test": {
        "description": "Create a throughput test between two devices.\n        \n        Args:\n            serial: Source device serial\n            target_serial: Target device serial\n            \n        Returns:\n            Throughput test job details",
        "parameters": [{"name": "serial", "type": "str", "default": None, "required": True}, {"name": "target_serial", "type": "str", "default": None, "required": True}]
    },
    "get_device_throughput_test": {
        "description": "Get results of a throughput test.\n        \n        Args:\n            serial: Device serial number\n            test_id: Test job ID\n            \n        Returns:\n            Throughput test results",
        "parameters": [{"name": "serial", "type": "str", "default": None, "required": True}, {"name": "test_id", "type": "str", "default": None, "required": True}]
    },
    "create_switch_cable_test": {
        "description": "Run cable diagnostic test on a switch port.\n        \n        Args:\n            serial: Switch serial number\n            port: Port ID (e.g., \"1\", \"5\")\n            \n        Returns:\n            Cable test job details",
        "parameters": [{"name": "serial", "type": "str", "default": None, "required": True}, {"name": "port", "type": "str", "default": None, "required": True}]
    },
    ...
    "create_device_wake_on_lan": {
        ...
        "parameters": [{"name": "serial", "type": "str", "default": None, "required": True}, {"name": "vlan_id", "type": "int", "default": None, "required": True}, {"name": "mac_address", "type": "str", "default": None, "required": True}]
    },
    ...
    "get_switch_mac_table": {
        ...
        "parameters": [{"name": "serial", "type": "str", "default": None, "required": True}, {"name": "request_id", "type": "str", "default": None, "required": True}]
    },
    "blink_device_leds": {
        "description": "Blink device LEDs to help identify it physically.\n        \n        Args:\n            serial: Device serial number\n            duration: Duration in seconds (default 30)\n            \n        Returns:\n            LED blink job details",
        "parameters": [{"name": "serial", "type": "str", "default": None, "required": True}, {"name": "duration", "type": "int", "default": "30", "required": False}]
    },
}
